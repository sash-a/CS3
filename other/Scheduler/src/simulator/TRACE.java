 ...
 * <p>
 * A value of say, 11, causes context switching, system call and interrupt
 * handler entry to be traced.  *
...
public class TRACE
{
    ...
    /**
     * If GET_TRACE_LEVEL()&level!=0 then perform System.out.printf(format,
     * args) else do nothing.
     */
