...
/**
 * A CPU object stores the currently executing process, provides a method for
 * performing context switches, and records the number of context switches that
...
public class CPU
{
    ...
    /**
     * Exeucte the current process in user space until it terminates or blocks
     * for IO.
     * <p>
     ...
     * (<code>getCurrentProcess()==null</code>).
     */
